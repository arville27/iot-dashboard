  ...
  return (
    <>
      <div className="flex w-full justify-end">
        <button
          className="m-3 flex gap-3 rounded bg-primary py-2 px-4 text-sm font-bold text-primary-content hover:bg-blue-700"
          onClick={openModal}
        >
          <svg
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-base-200 p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <form action="">
                      <input
                        className="w-full rounded bg-base-100 px-3 py-1"
                        type="text"
